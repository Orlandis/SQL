...
onePosition Кво_чеков_с_1_входом, morePosition 'Кво_чеков_с_входом > 2 позиций', (sum1+sum2) Сумма_проданных_акц_позиций, round((((onePosition + morePosition) / cast(count_all_checks as float(5)))*100),2) '% Пенитрации'
